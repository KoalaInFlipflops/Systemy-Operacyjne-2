...
FILE_4_SAVING_RESULTS="${FILE_4_SAVING_RESULTS:-results.txt}"
...
if [[ -z ${MOVIES_DIR+x} ]]; then
    print_error "ERROR: -d flag is mandatory. Please provide the directory with files describing movies."
    exit 1
fi
